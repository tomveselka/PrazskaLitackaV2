namespace PrazskaLitacka.Webapi.Constants;

public static class UserConstants
{
    public const string AlreadyExistsActive = "already_exists_active";
    public const string AlreadyExistsInactive = "already_exists_inactive";
